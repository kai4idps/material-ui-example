                        ...
                        <div className="p-4">
                            ...
                            <Form className="mt-3" id="loginform" action="/dashbaord">
                                ...
                                <InputGroup className="mb-2" size="lg">
                                    ...
                                    <Input type="email" id="email" name="email" value={email} onChange={e => {setEmail(e.target.value); onInputChange(e)}} placeholder="Email" />
                                </InputGroup>
                                {showErrors('email')}
                                ...
                                <InputGroup className="mb-3" size="lg">
                                    ...
                                    <Input type="password" id="password" name="password" value={password} onChange={e => {setPassword(e.target.value); onInputChange(e)}} placeholder="Password" />
                                </InputGroup>
                                {showErrors('password')}
                                ...
                                <Row className="mb-3">
                                    <Col xs="12">
                                        <Button color="primary" onClick={event => doLogin(event)} className={`${validForm() ? '' : 'disabled'}`} size="lg" type="submit" block>Log In</Button>
                                    </Col>
                                </Row>
