...
export default (props) => {
    ...
    return (
        <div>
            <div className="p-3">
                <span onClick={toggle.bind(null)} className="btn btn-danger d-block text-white">New Contact</span>
            </div>
            ...
            <Modal isOpen={modal} toggle={toggle.bind(null)} className={props.className} size="md">
