...
const ContactsDetails = () => {
    ...
    const selectedContacts = useSelector((state) => state.contactReducer.contacts[state.contactReducer.contactsDetails]);
                ...
                <div className="">
                    <div className="d-flex align-items-center p-4 border-bottom">
                        ...
                        <div>
                            ...
                            {editContactFlag ?
                                <Button className="btn btn-success mt-2" size="sm" onClick={() => dispatch(setEditContactFlag())}>Save</Button>
                                :
                                <Button className="btn btn-info mt-2" size="sm" onClick={() => dispatch(setEditContactFlag())}>Edit</Button>
                            }
                        </div>
                    </div>
                                    ...
                                    <td className="col-9">
                                        {editContactFlag ? (
                                            <Input
                                                ...
                                                onChange={e => dispatch(updateContact(selectedContacts.id, "firstname", e.target.value))}
                                            />
                                        ) : (
                                    ...
                                    <td className="col-9">
                                        {editContactFlag ? (
                                            <Input
                                                ...
                                                onChange={e => dispatch(updateContact(selectedContacts.id, "lastname", e.target.value))}
                                            />
                                        ) : (
                                    ...
                                    <td className="col-9">
                                        {editContactFlag ? (
                                            <Input
                                                ...
                                                onChange={e => dispatch(updateContact(selectedContacts.id, "company", e.target.value))}
                                            />
                                        ) : (
                                    ...
                                    <td className="col-9">
                                        {editContactFlag ? (
                                            <Input
                                                ...
                                                onChange={e => dispatch(updateContact(selectedContacts.id, "department", e.target.value))}
                                            />
                                        ) : (
                                    ...
                                    <td className="col-9">
                                        {editContactFlag ? (
                                            <Input
                                                ...
                                                onChange={e => dispatch(updateContact(selectedContacts.id, "email", e.target.value))}
                                            />
                                        ) : (
                                    ...
                                    <td className="col-9">
                                        {editContactFlag ? (
                                            <Input
                                                ...
                                                onChange={e => dispatch(updateContact(selectedContacts.id, "phone", e.target.value))}
                                            />
                                        ) : (
                                    ...
                                    <td className="col-9">
                                        {editContactFlag ? (
                                            <Input
                                                ...
                                                onChange={e => dispatch(updateContact(selectedContacts.id, "address", e.target.value))}
                                            />
                                        ) : (
                                    ...
                                    <td className="col-9">
                                        {editContactFlag ? (
                                            <Input
                                                ...
                                                onChange={e => dispatch(updateContact(selectedContacts.id, "notes", e.target.value))}
                                            />
                                        ) : (
