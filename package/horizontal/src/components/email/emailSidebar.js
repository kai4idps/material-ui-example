...
const EmailSidebar = () => {
    ...
    return (
        <div>
            <div className="p-3">
                <span onClick={toggle.bind(null)} className="btn btn-danger d-block text-white">Compose</span>
            </div>
            ...
            <Modal isOpen={composeModal} toggle={toggle.bind(null)} size="lg">
                <ModalHeader toggle={toggle.bind(null)}>Compose New Message</ModalHeader>
                <ModalBody>
                    <Form>
                ...
                <ModalFooter>
                    <Button color="primary" onClick={toggle.bind(null)}>Send</Button>{' '}
